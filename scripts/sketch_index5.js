...
let indexsketch = function (p) {
    ...
    p.draw = function () {
        ...
        if (loaded) {
            ...
            p.fill(random1Value2, random1Value3, random1Value3, 0.3);
            ...
            p.fill(random2Value2, random2Value3, random2Value3, 0.3);
            ...
            p.fill(random3Value2, random3Value3, random3Value3, 0.3);
            ...
            p.fill(random4Value2, random4Value3, random4Value3, 0.3);
            ...
            p.fill(random5Value2, random5Value3, random5Value3, 0.3);
            ...
            p.fill(random6Value2, random6Value3, random6Value3, 0.3);
            ...
            p.fill(random7Value2, random7Value3, random7Value3, 0.3);
            ...
            p.fill(random8Value2, random8Value3, random8Value3, 0.3);
            ...
            p.fill(random9Value2, random9Value3, random9Value3, 0.3);
            ...
            p.fill(random10Value2, random10Value3, random10Value3, 0.3);
            ...
            p.fill(random11Value2, random11Value3, random11Value3, 0.3);
            p.textSize(random11Value4);
            p.text(columnData11[random11], p.random(p.width), p.random(p.height));
            p.fill(p.random(0, 360), p.random(0, 100), p.random(0, 100), 0.3);

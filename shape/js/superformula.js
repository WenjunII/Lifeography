...
function render() {
    ...
    {	
        for ( var p = 0 ; p < controls.radialSegments; p++)
        {
            ...
            t11 = Math.cos((controls.m1 * i) /4 ) / controls.a1 + Math.sin(Date.now() / 100000);
            t11 = Math.abs(t11);
            t11 = Math.pow(t11,controls.n21);

            t21 = Math.sin((controls.m1 * i) /4 ) / controls.b1 + Math.sin(Date.now() / 100000);
            t21 = Math.abs(t21);
            t21 = Math.pow(t21,controls.n31);

            r1 = Math.pow(t11+t21, 1/controls.n11);

            t12 = Math.cos((controls.m2 * j) /4 ) / controls.a2 + Math.sin(Date.now() / 100000);
            t12 = Math.abs(t12);
            t12 = Math.pow(t12,controls.n22);

            t22 = Math.sin((controls.m2 * j) /4 ) / controls.b2 + Math.sin(Date.now() / 100000);
            t22 = Math.abs(t22);
